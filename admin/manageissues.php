...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Quản lý yêu cầu</li>
            </ol>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost:81/hochtml/webdulich/admin/updateissue.php?iid=<?php echo ($result->id);?>');">Phản hồi</a> 
</td>
