...
{				?>		
						  <tr>
							...
							<td>Từ <?php echo htmlentities($result->fdate);?> Đến <?php echo htmlentities($result->tdate);?></td>
...
<?php if($result->status==2)
{
	?><td>Đã huỷ</td>
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn hủy đặt phòng không ')" >Huỷ</a> / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Xác nhận thành công')" >Xác nhận</a></td>
<?php }?>
