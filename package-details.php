...
<div class="banner-3">
	<div class="container">
		<h1 class="" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Chi tiết tour</h1>
	</div>
</div>
<!--- /banner ---->
<!--- selectroom ---->
...
<form name="book" method="post">
		...
		<div class="selectroom_top">
			...
			<div class="selectroom-info" data-wow-duration="1200ms" data-wow-delay="500ms" style="visibility: visible; margin-top: -70px">
				<!-- animation-duration: 1200ms; animation-delay: 500ms; animation-name: fadeInUp;: hiệu ứng chuyển động -->
				<ul>
