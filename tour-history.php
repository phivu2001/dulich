...
$msg="Đã hủy đặt tour thành công ";
}
else
{
...
<div class="privacy">
	<div class="container">
		<h3 class="" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Lịch sử tour</h3>
...
{
echo "Đã hủy bởi quản trị viên lúc " .$result->upddate;
...
<?php if($result->status==2)
{
	?><td>Bị huỷ bỏ</td>
<?php } else {?>
<td><a href="tour-history.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có thực sự muốn hủy đặt tour không ')" >Huỷ</a></td>
<?php }?>
</tr>
<?php $cnt=$cnt+1; }} ?>
	</table>
