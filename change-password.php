...
$error="Email hoặc Số di động không hợp lệ ";	
}
}
...
<div class="privacy">
	<div class="container">
		<h3 class="" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Đổi mật khẩu</h3>
